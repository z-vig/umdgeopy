...
You can download VSCode at the [VSCode website](https://code.visualstudio.com/download). The first thing you will see when you open your new IDE is a blank page. Locate the file menu and select Open Folder...
